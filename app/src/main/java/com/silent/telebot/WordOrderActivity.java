...
Raw file content
Skip to content
almhdi-soft779551518-
Repository navigation
Code
Issues
Pull requests
almhdi-soft779551518-/app/src/main/java/com/silent/telebot
/ordOrderActivity.java
esaarm120-pixel
esaarm120-pixel
11 minutes ago
418 lines (335 loc) · 12.6 KB
...
public class WordOrderActivity extends Activity {
    ...
    private final String[] words = {
            "كتاب", "شجرة", "مدرسة", "حديقة",
            "مكتبة", "سيارة", "تفاحة", "نجاحك",
            "مغامر", "عبقري", "مبدع", "انتصار"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // اسم الواجهة هو activity_crossword.xml
    ...
    private void loadWord() {
        ...
        for (String letter : letters) {
            ...
            button.setOnClickListener(v -> {
                v.setEnabled(false);
                selectedLetters.add(button.getText().toString());
    ...
    private void buildCrossword() {
        ...
        for (int row = 0; row < 5; row++) {
            for (int column = 0; column < 5; column++) {
                ...
                boolean enabled = solution[row][column] != ' ';
